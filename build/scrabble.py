...
class Game:
    ...
    def turn(self, player, board, bag):
        ...
        if (self.skipped_turns < 6) or (player.rack.get_rack_length() == 0 and bag.get_remaining_tiles() == 0):
            ...
            # === AI PLAYER LOGIC ===
            if player.get_name().upper() in ["AI", "AI_MCTS", "AI_BEAM", "AI_GBFS", "AI_A"]:
    ...
    def end_game():
        ...
        del all_player_scores[winning_player]
        print("The game is over! " + winning_player + ", you have won with " + highest_score + "points!")
        for player, score in all_player_scores:
            print(player + " ended the game with " + score + "points!")
